        ...
        >
          ...
          <div class="flex flex-col gap-4 min-h-0">
            ...
            <div class="glass-card p-4 relative flex-shrink-0">
              ...
              <div class="relative mb-3">
                ...
                <div
                  ...
                  class="absolute -top-1 right-0 w-14 h-14 bg-white rounded-lg p-1 flex items-center justify-center shadow"
                >
                  <img
              ...
              <!-- Host -->
              <div>
                <p class="text-wc-cream/50 text-xs uppercase tracking-wider mb-0.5">
                  Hosted by
                </p>
                <p class="text-lg font-semibold text-wc-cream">
            ...
            <div class="glass-card p-4 flex-shrink-0">
              <h3 class="text-wc-gold/60 text-xs uppercase tracking-wider mb-3">
                Champions
              </h3>
              <div class="flex items-center">
                <span class="winner-flag text-3xl">{{ currentWorldCup.winner.flag }}</span>
                <div>
                  <p class="text-xl font-semibold text-wc-cream">
                    {{ currentWorldCup.winner.country }}
                  </p>
                  <p
              ...
              <div
                v-if="currentWorldCup.runnerUp"
                class="mt-3 pt-3 border-t border-wc-gold/10"
              >
                <p class="text-wc-cream/50 text-xs">
                  vs
                </p>
            ...
            >
              ...
              <ul class="space-y-2 overflow-y-auto scrollbar-thin flex-1 min-h-0 pr-1">
                ...
                >
                  <span class="fun-fact-bullet mt-1.5" />
                  <span>{{ fact }}</span>
                </li>
              </ul>
            </div>
                ...
                >
                  ...
                  <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                      <p class="text-wc-cream font-semibold text-sm truncate">
                        {{ city.name }}
                      </p>
                      <p
                        v-if="city.stadium"
                        class="text-wc-cream/50 text-xs truncate mt-0.5"
                      >
                        {{ city.stadium }}
                      </p>
                    </div>
          ...
          <div class="glass-card p-4 flex flex-col min-h-0">
            ...
            <p class="text-wc-cream/80 leading-relaxed text-sm overflow-y-auto scrollbar-thin flex-1 min-h-0 pr-1">
              {{ currentWorldCup.description }}
            </p>
          </div>
        </div>
      </div>
